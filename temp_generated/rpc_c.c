 ...
 */
/* Compiler settings for C:\Users\anton\source\repos\TrayApp\src\common\rpc_interface.idl:
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&ServiceControl_StubDesc,
                  (PFORMAT_STRING) &rpc_interface__MIDL_ProcFormatString.Format[144],
                  IDL_handle);
    return ( long  )_RetVal.Simple;
    ...
    /* [string][out] */ wchar_t **username)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&ServiceControl_StubDesc,
                  (PFORMAT_STRING) &rpc_interface__MIDL_ProcFormatString.Format[180],
                  IDL_handle,
                  username);
    return ( long  )_RetVal.Simple;
    ...
    /* [string][in] */ const wchar_t *deviceMac)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&ServiceControl_StubDesc,
                  (PFORMAT_STRING) &rpc_interface__MIDL_ProcFormatString.Format[264],
                  IDL_handle,
                  activationCode,
                  deviceMac);
    return ( long  )_RetVal.Simple;
